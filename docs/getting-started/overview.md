...
| --- | --- |
| CLI product surface | React/Ink `cognibrain` home, self-hosted profiles, memory workbench, connections workbench, config, harness config, skill lifecycle and `doctor --fix`. |
