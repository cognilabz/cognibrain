...
- Self-hosted ownership: teams can run the CLI-first operator surface, API, native service startup, optional dashboard, MCP server, connectors and storage under their own controls. Claim IDs: `CB-CLAIM-PRODUCTION`, `CB-CLAIM-STORAGE`.
