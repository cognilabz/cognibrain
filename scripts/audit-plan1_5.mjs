...
const checks = [
  ...
  check("guided self-hosted install is wired", [
    ...
    has(files.cli, "connector-catalog"),
    has(files.cli, "adapter-catalog"),
    has(files.cli, "sdk-catalog"),
    has(files.cli, "config-doctor"),
    has(files.cli, "cognibrain doctor"),
  ...
  check("setup UX and docs are product-ready", [
    ...
    has(files.setupCli, "Ink CLI Screenshots"),
    has(files.package, "\"docs:cli-screenshots\""),
    exists("scripts/render-cli-screenshots.mjs"),
    exists("docs/assets/cli-home.svg"),
    exists("docs/assets/cli-memories.svg"),
