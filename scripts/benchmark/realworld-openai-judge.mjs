...
const apiKey = process.env.MEMORY_REALWORLD_JUDGE_OPENAI_API_KEY;
if (!apiKey) fail("MEMORY_REALWORLD_JUDGE_OPENAI_API_KEY is required for the explicit RealWorld benchmark harness judge");
