...
revalidateSourceRefs(
  ...
  resolveVerificationQueueAsync(userId: string, options: { limit?: number; connectorIds?: string[] } = {}): Promise<VerificationResolutionReport> {
    return resolveVerificationQueueAsyncImpl(this, userId, options);
  }
  ...
  confirmMemoryAsync(memoryId: string, userId?: string): Promise<Memory> {
    return confirmMemoryAsyncImpl(this, memoryId, userId);
  }
  ...
  recordHarnessActionAsync(input: HarnessActionInput): Promise<Memory> {
    return recordHarnessActionAsyncImpl(this, input);
  }
  ...
  recordHarnessLifecycleEventAsync(input: HarnessLifecycleEventInput): Promise<HarnessLifecycleEventReport> {
    return recordHarnessLifecycleEventAsyncImpl(this, input);
  }
  ...
  retractMemoryAsync(memoryId: string, userId?: string, reason?: string): Promise<Memory> {
    return retractMemoryAsyncImpl(this, memoryId, userId, reason);
  }
