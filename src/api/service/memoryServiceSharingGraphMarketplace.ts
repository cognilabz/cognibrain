...
export class MemoryServiceSharingGraphMarketplace extends MemoryServiceConnectorsAdmin {
  ...
  updateConsentAsync(memoryId: string, consent: Partial<ConsentPolicy>): Promise<Memory> {
    return updateConsentAsyncImpl(this, memoryId, consent);
  }
  ...
  revertMemoryAsync(memoryId: string, auditEventId?: string): Promise<Memory> {
    return revertMemoryAsyncImpl(this, memoryId, auditEventId);
  }
