...
- actively request a coding context pack with `__COGNIBRAIN_COMMAND__ context --task "<task>" --app devin-style --agent devin-style --json`; do not wait for memories to appear in the prompt,
