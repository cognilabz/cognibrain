...
- Actively pull a context pack before changing code; use `__COGNIBRAIN_COMMAND__ context --task "<task>" --app sourcegraph-amp --agent sourcegraph-amp --json` or the coding-specific context path when the host exposes it.
